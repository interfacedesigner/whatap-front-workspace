...
Comprehensive performance optimization guide for React SPA applications. Contains 37 rules across 7 categories, prioritized by impact to guide automated refactoring and code generation.
...
| 3        | Client-Side Optimization | MEDIUM-HIGH | `client-`    |
...
### 3. Client-Side Optimization (MEDIUM-HIGH)
