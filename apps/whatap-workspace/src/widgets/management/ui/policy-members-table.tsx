...
interface PolicyMembersTableProps {
  members: Member[];
  wsid: string;
  onMemberClick?: (member: Member) => void;
}

export function PolicyMembersTable({ members, wsid, onMemberClick }: PolicyMembersTableProps) {
  return (
    <Card>
      ...
      <CardContent>
        {members.length === 0 ? (
          <p className='py-6 text-center text-sm text-muted-foreground'>No members assigned</p>
        ) : (
