const defaultStyle =
  'border: none; display: block; float: left; width: 6px; height: 6x; margin-right: 5px; margin-top: 0px;';
...
class Tooltip {
  ...
  append = (evt, textContent) => {
    ...
    this.topPos =
      height + this.evtY + 10 < document.body.offsetHeight - scrollY
        ? this.evtY + scrollY
        : this.evtY - height + scrollY;
    this.leftPos =
      width + this.evtX + 10 < document.body.offsetWidth - scrollX
        ? this.evtX + scrollX + 10
        : this.evtX + scrollX - width - 20;
